 ...
 * 版本：1.0
 *
 * 创建日期： 2016年3月9日  下午7:23:13
 *
 * 描述：JAVA获取中文名字的首字母，
 * 	
 * 	例如：FirstLetterUtil.getFirstLetter("刘军")   return: lj  
 * 
 * 		FirstLetterUtil.getFirstLetter("liujun")   return: lunjun 
 *
 * 全局接口公共部分：
 *
 * 修订历史：
...
public class FirstLetterUtil {
	...
	public static void main(String[] args) {
		...
		String firstLetter = FirstLetterUtil.getFirstLetter("刘军");
